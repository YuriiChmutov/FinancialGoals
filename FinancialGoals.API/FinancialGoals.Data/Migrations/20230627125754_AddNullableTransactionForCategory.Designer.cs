...
namespace FinancialGoals.Data.Migrations
{
    ...
    [Migration("20230627125754_AddNullableTransactionForCategory")]
    partial class AddNullableTransactionForCategory
    {
            ...
            modelBuilder.Entity("FinancialGoals.Core.Models.Transaction", b =>
                {
                    b.HasOne("FinancialGoals.Core.Models.Category", "Category")
                        .WithOne("Transaction")
                        .HasForeignKey("FinancialGoals.Core.Models.Transaction", "CategoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

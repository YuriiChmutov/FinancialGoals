...
namespace FinancialGoals.Data.Migrations
{
    ...
    [Migration("20230725073927_UpdateManyToManyBetweenUsersAndGoals")]
    partial class UpdateManyToManyBetweenUsersAndGoals
    {
            ...
            modelBuilder.Entity("CategoryUser", b =>
                {
                    ...
                    b.HasOne("FinancialGoals.Core.Models.User", null)
                        .WithMany()
